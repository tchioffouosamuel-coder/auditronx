    ...
    <DataTable
      ...
      columns={[
        ...
        { key: "nb_seances_realisees", label: "Réalisées" },
        {
          ...
          label: "Taux",
          render: (f) => (
            <span className={f.en_retard ? "text-red-600" : "text-green-600"}>
              {f.taux_avancement}%
            </span>
          ),
  ...
  return (
    <div>
      ...
      {tab === "programmes" && (
        <>
          <div className="mb-4">
            <SpreadsheetActions entity="progressions" label="progressions" />
          </div>
          <ResourceTable
            title=""
            resource="/programmes"
            ...
            fields={[
              ...
              },
              {
                ...
                label: "Discipline",
                type: "select",
                optionsUrl: "/disciplines",
                required: true,
              },
              {
                key: "annee_scolaire",
                label: "Année scolaire (ex. 2026-2027)",
                required: true,
              },
              {
