...
inline constexpr char BLE_DEVICE_NAME[] = "AUDITRON-LBM-01";
...
// TODO : renseigner le WiFi du site LBM (valeurs ci-dessous copiées de la
...
// ---- API distante ----
// Établissement : Lycée Bilingue de Meiganga (LBM)
...
// TODO : provisionner un token propre à l'instance api-lbm (celui ci-dessous
// est encore celui de l'instance api-ltm de référence et ne fonctionnera pas).
inline constexpr char RELAY_API_TOKEN[] = "REPLACE_WITH_LBM_RELAY_TOKEN";
