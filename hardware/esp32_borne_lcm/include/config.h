...
inline constexpr char BLE_DEVICE_NAME[] = "AUDITRON-LCM-01";
...
// TODO : renseigner le WiFi du site LCM (valeurs ci-dessous copiées de la
// borne de référence api-ltm, à remplacer avant déploiement).
...
// ---- API distante ----
// Établissement : Lycée Classique de Meiganga (LCM)
...
// TODO : provisionner un token propre à l'instance api-lcm (celui ci-dessous
// est encore celui de l'instance api-ltm de référence et ne fonctionnera pas).
inline constexpr char RELAY_API_TOKEN[] = "REPLACE_WITH_LCM_RELAY_TOKEN";
