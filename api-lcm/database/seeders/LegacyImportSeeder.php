 ...
 * de l'ancienne instance LCM (base "u332279927_auditron_lcm") — à lancer une
 * seule fois après la mise en service de cette instance dédiée :
 *
 *   php artisan db:seed --class=LegacyImportSeeder
 *
 * Le dump (database/seeders/legacy/auditron_lcm_dump.sql) est d'abord chargé
...
class LegacyImportSeeder extends Seeder
{
    ...
    private function loadLegacyDump(): void
    {
        ...
        $path = __DIR__.'/legacy/auditron_lcm_dump.sql';
